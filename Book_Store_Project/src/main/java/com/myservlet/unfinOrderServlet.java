...
import com.bookstore.beans.BookOrder;
import com.bookstore.dao.UserDao;
import com.mypackage.ShoppingCart;
import com.myserviece.UserException;
import com.myserviece.UserService;
...
public class unfinOrderServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		for(int i=0;i<bookorder.size();i++){
			System.out.println("servlet"+bookorder.get(i).toString());
